...
extern const MIDL_SERVER_INFO GumballRemote_ServerInfo;

extern RPC_DISPATCH_TABLE GumballRemote_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE GumballRemote___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xd483d70c,0xf79d,0x4b15,{0x86,0x56,0xf7,0xaa,0xd0,0xe6,0x88,0x56}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    &GumballRemote_v1_0_DispatchTable,
    0,
    0,
    0,
    &GumballRemote_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE GumballRemote_v1_0_s_ifspec = (RPC_IF_HANDLE)& GumballRemote___RpcServerInterface;
...
static const MIDL_STUB_DESC GumballRemote_StubDesc = 
    {
    (void *)& GumballRemote___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION GumballRemote_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
RPC_DISPATCH_TABLE GumballRemote_v1_0_DispatchTable = 
    {
    3,
    GumballRemote_table
    };

static const SERVER_ROUTINE GumballRemote_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)getLocation,
    (SERVER_ROUTINE)getCount,
    (SERVER_ROUTINE)getStateString
    };

static const MIDL_SERVER_INFO GumballRemote_ServerInfo = 
    {
    &GumballRemote_StubDesc,
    GumballRemote_ServerRoutineTable,
    GumballRemote__MIDL_ProcFormatString.Format,
    GumballRemote_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
