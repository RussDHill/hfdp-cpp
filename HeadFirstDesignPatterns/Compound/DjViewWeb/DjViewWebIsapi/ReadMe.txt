========================================================================
       ATL SERVER : DjViewWebIsapi Project Overview
========================================================================

AppWizard has created this DjViewWebIsapi application for you.  This application
...
make up your DjViewWebIsapi application.

DjViewWebIsapi.vcproj
...
DjViewWebextension.h
    This file contains your CIsapiExtension derived ISAPI Extension class:
    CDjViewWebExtension that is customized based on the options you chose 
    in the AppWizard.
